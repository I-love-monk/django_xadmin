...
from users.forms import LoginForm, RegisterForm, ForgetForm, ModifyPwdForm, UserInfoForm, UploadImageForm
...
class UserInfoView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if user_info_form.is_valid(request.POST, instance=request.user):
            user_info_form.save()
